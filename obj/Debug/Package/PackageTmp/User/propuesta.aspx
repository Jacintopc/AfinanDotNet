...
<body style="width:900px;  margin-left:auto; margin-right:auto;" onload="PagePrint();">
    ...
    <div id="Encabezado" style="Width:100%; height:115px; ">
        <div style="float:left; position:absolute; margin: 3px; "> <img alt="Afinan.net" src="/Images/Montaje3.jpg" /></div>
        <div style="font-size: x-large; float:right; margin: 5px; width:400px; text-align:right">Propuesta de Renting
        <table style="font-size: small;  width:400px; color:Navy;" runat="server">
            <tr>
    ...
    <div id="tabladatos">
        ...
        <table id="tablacondiciones" style="border:2px solid black; width:90%; margin:20px auto 20px auto;" runat="server">
            ...
            <tr>
                <td><b>Matricula y material de seguridad para </b> </td>
    ...
    <div id="notas y firma" style="margin-left:20px; margin-right:20px; font-size: medium;">
        ...
        <span>Cuota informativa sujeta a la validez técnica de las facturas proforma. Oferta condicionada a la aprobación de la sociedad de Renting con validez 1 mes.</span>
        ...
        <div style="margin-top:30px; font-style:italic; font-weight:bold; border: 2px solid black; padding:10px; "> 
            <span>Por favor, envíenos su número de DNI por correo electrónico con su nombre y le informaremos si podemos presentar la operación a un banco. Gracias por su confianza.</span>
        </div> 
    </div>
    <div id="piedepagina" style="text-align:center; font-size:smaller; margin-top:10px;">
        <span>AFINAN - Marina Puerto Tarraco - Moll de Lleida - Edificio 3 Local 5 - 43004 TARRAGONA - España</span><br />
        <span>Fax: +34 877 021 219 - Email: rentingnautico@afinan.com</span>    
    </div>
