...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: 95%;  margin: 5px auto 5px auto; padding: 10px;">
        <h2>Aplicación para el cálculo de financiación de nautica</h2>
    ...
    <div style="width:390px; background-color: #ffffdd ; border: 1px solid black; margin: 35px auto 15px auto; padding: 5px; -moz-border-radius: 8px; -webkit-border-radius: 8px;">
        ...
        <asp:Login ID="LoginAfinan" runat="server" BackColor="#ffffdd" Font-Names="Verdana" 
            Font-Size="1em" ForeColor="#333333" Width="380px"  
            OnLoggedIn="UsuarioLoggedIn" 
            FailureText="Su intento de logon ha fallado. Inténtelo de nuevo." PasswordRequiredErrorMessage="Es necesaria una contraseña." UserNameRequiredErrorMessage="Es necesario un nombre de usuario." UserNameLabelText="Usuario:" PasswordLabelText="Contraseña:">
                            ...
                            <table cellpadding="0" style="width:380px;">
                                ...
                                <tr style="height:30px;">
                                    <td align="center" colspan="2">
                                        <asp:Button ID="LoginButton" CssClass="botom_menu" runat="server" CommandName="Login" 
                                             Text="Entrar"  CausesValidation ="true" ValidationGroup="LoginAfinan" />
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    <div style="border:2px solid #4b6c9e; color: Navy; background-color: #FFFFDD; margin:50px ; padding:10px; -moz-border-radius: 8px; -webkit-border-radius: 8px;" runat="server" >
    <b>AVISO 23-11-2010</b> <br /> Nueva versión mejorada, con opción de escoger valores residuales: 0% (=6€), 5%, 10%, 15% y 20%, que permite más opciones
    y combinaciones, pudiendo disminuir la cuota en base a un Valor Residual más alto. <br />
    El importe del Valor Residual es siempre a pagar al final por parte del cliente y sujeto a la aprobación por parte del banco. 
    </div>
    </asp:Content>
